<h1 align="center">The Great Thinker</h1>
<p align="center">An application to simulate a toy from a TV Show, that answer anything.</p>
...
- In this project I wanted to go back to the basic of web development and have some fun with html, css and javascript(I used typescript, but is compile to javascript, I think still count) 
